...
var init = function(){
  ...
  blastSound = new Audio('son/blast.mp3');
  lifeSound = new Audio('son/life.mp3');
  ingameMusic = new Audio('son/pray.mp3');
  endMusic = new Audio('son/end.mp3');
  
  			/*Images*/

  spaceshipImg = new Image();
  spaceshipImg.src = "images/starship.png";
  shotImg = new Image();
  shotImg.src = 'images/laser.png';
  flyingSaucerImg = new Image();
  flyingSaucerImg.src = 'images/enemy-starship.png';
  lifeImg = new Image();
  lifeImg.src = 'images/life.gif';  
